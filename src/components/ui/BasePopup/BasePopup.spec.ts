...
describe('BasePopup', () => {
  ...
  it('correctly showing popup when prop isVisible is true', () => {
  ...
  it('correctly hiding popup when prop isVisible is false', async () => {
  ...
  it('correctly emit click on popup backdrop', async () => {
